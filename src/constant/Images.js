...
export default {
	...
	luwiLogoLong: require('../assets/images/luwiLogoLong.png').default,
	...
	openEyeGrey: require('../assets/images/open_eye_grey.svg').default,
	openEyeBlack: require('../assets/images/open_eye_black.svg').default,
};
